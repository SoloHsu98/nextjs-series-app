...
import { GET_UPCOMING_SERIES } from "../graphql/queries/series";
import { useStoreContext } from "../lib/context";
import apolloClient from "../utils/apolloClient";

const Trending = () => {
  // const [results] = useQuery({ query: GET_TRENDING_SERIES });
    ...
    <div>
      <div css={styles.container}>
        <div className="d-flex justify-content-between">
          <h2 css={styles.title}>All Upcoming Series</h2>
